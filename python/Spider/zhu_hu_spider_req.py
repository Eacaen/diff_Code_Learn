...
tb = "https://www.zhihu.com/people/hehe-eacaen/following"

# cook = session.get("http://www.zhihu.com/cookies", headers=headers)
...
response = session.get(tb , headers=follo_headers)
